 ...
 * generated in the soapcliente package. 
...
public class ObjectFactory {
    ...
    private final static QName _Sumar_QNAME = new QName("http://webservice.empresaurios.com/", "sumar");
    private final static QName _SumarResponse_QNAME = new QName("http://webservice.empresaurios.com/", "sumarResponse");

    /**
     * Create a new ObjectFactory that can be used to create new instances of schema derived classes for package: soapcliente
     * 
     */
     ...
     * 
     */
    @XmlElementDecl(namespace = "http://webservice.empresaurios.com/", name = "sumar")
     ...
     * 
     */
    @XmlElementDecl(namespace = "http://webservice.empresaurios.com/", name = "sumarResponse")
